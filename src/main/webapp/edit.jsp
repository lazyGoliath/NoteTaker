<%@page
	import="org.hibernate.Session, com.helper.FactoryProvider, com.entities.Note"%>
...
%>
		...
		<form action="UpdateServlet" method="post">
			<div class="mb-3">
				<input value="<%= note.getId() %>" name="noteId" type="hidden" /> <label
					for="title" class="form-label">Note Title</label> <input
					name="title" required placeholder="Enter your title here"
					value="<%= note.getTitle() %>" type="text" class="form-control"
